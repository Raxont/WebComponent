...
export class MyElement extends LitElement {
  ...
  async loadSong() {
    //const url = 'https://spotify23.p.rapidapi.com/artist_singles/?id=2w9zwq3AktTeYYMuhMjju8&offset=0';
    const options = {
      method: "GET",
      headers: {
        "X-RapidAPI-Key": "d0c96fbac6mshe22e5d5567a1494p1b20dejsn1b84f1e035e0",
                ...
                <div class="card">
                  <div class="cards">
                    <div class="cards_info">
                      ...
                      <div class="img">
                        <img
                          src="${song.releases.items[0].coverArt.sources[0]
                            .url}"
                        />
                      </div>
